...
def get_predict_input_args():
    ...
    parser.add_argument('--number_of_classes', type = int, help = 'Number of classes to classify', default = 2)
    parser.add_argument('--checkpoint_folder',  type=str, help='Path to checkpoints folder', default= 'checkpoints')
    parser.add_argument('--checkpoint_file', type=str, help='Path to checkpoints folder', default='checkpoint.pth')
